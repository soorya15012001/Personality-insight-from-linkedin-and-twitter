...
def index(liu, req_by, pub_id, key_name, key_company, key_role, twitter_id, li_at, csrf_token, x):
    with requests.session() as s:
        ...
        if liu == "":
            ...
            if t[max(t.keys())] == 1:
                ...
                print("############### CNN_FL_UB")
                model_l = load_model("models/cnn_FL_UB.h5")
                label_J = load_model("models/cnn_MBTI_FL_UB.h5")
