...
def index(key_name, text, model_l_1, model_l_2, label_J_1, label_J_2):
    tx = {}
    disc_key_traits = {
        "D": "Strong Willed",
        "I": "Open Networker",
...
model_l_1 = load_model("models/cnn_CE_B_SM.h5")
label_J_1 = load_model("models/cnn_MBTI_CE_B_SM.h5")
model_l_2 = load_model("models/cnn_FL_UB.h5")
label_J_2 = load_model("models/cnn_MBTI_FL_UB.h5")

for i, l in tqdm(zip(key, text)):
    if i == "####":
        break
    else:
        tx = index(i, l, model_l_1, model_l_2, label_J_1, label_J_2)
        op = tx["disc_OP"] + "-" + tx["mbti_OP"]
        print(i, "====>", tx["model_name"], "====>", op)
        fin.append(op)
# print(fin)
pd.DataFrame(fin).to_csv("verify_text.csv")